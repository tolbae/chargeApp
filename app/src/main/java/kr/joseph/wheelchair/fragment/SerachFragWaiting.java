...
/**
 * Created by Joseph on 2016-07-12.
 * 승인 대기중인 충전소 정보 Fragment 리스트
 */
@SuppressWarnings("ALL")
public class SerachFragWaiting extends Fragment {
        ...
        if(result_txt.equals("Not Found")){
            ...
            try {
                ...
                for(int i = 0; i < jaArray.length(); i++){
                    ...
                    Log.e("JSONArray Data", wc_permit+", "+wc_image+", "+wc_img_rotate+", "+wc_name+", "+wc_address+", "+wc_location+", "+wc_latitude+", "+wc_longitude+", "+wc_category+", "+
